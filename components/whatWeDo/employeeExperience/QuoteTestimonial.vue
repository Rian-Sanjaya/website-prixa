    ...
    <div class="quote-content">
      ...
      <div class="quote-box">
        <div class="quote-text">
          &#8220;Pengalaman perusahaan kami bekerja sama dengan Prixa untuk menangani <span style="font-style: italic;">health services</span> sejauh ini sangat membantu sekali. Semua kemudahan yang ditawarkan oleh aplikasi mobile Prixa yang bisa saya gunakan untuk mengajukan klaim, melihat benefit dan list provider sampai berkonsultasi dengan dokter secara online.&#8221;
        </div>
        <div class="quote-source">
          <div class="icon-content">
            <div class="icon-box">
              <img src="~/assets/images/employee-experience/quote-icon.png">
            </div>
          </div>
          <div class="source-text">
            ...
            <div class="source-sub-text">
              Direktur PT Pelita Cahaya Insani
            </div>
          </div>
        </div>
      </div>
