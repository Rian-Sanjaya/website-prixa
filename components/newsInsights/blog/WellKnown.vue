          ...
          <form class="form-content" @submit.prevent="register">
            <div class="form-item">
              ...
              <div class="item-input-box">
                <input v-model="subscribeEmail" type="text" class="font-12-14-14 item-input" placeholder="e.g. email@example.com" @keypress="onChangeEmail">
              </div>
              <div class="font-12-14-14 item-error">
                {{ errors.email }}
              </div>
              <div v-if="submitSuccess" class="font-12-14-14 item-success">
                Thank you, your email already stored!
              </div>
            </div>
